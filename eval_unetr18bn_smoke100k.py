...
from models.unet import UNet2D, UNetResNet18_BN_Scaled, UNetResNet18_BN_Scaled28, ResNet34_BN_Scaled
...
def val(args):
    ...
    dataset_test = SmokeCloud_Dataset_V2(ssspath=None, s100kpath='/project/data/smoke_cloud/smoke100k',mode='test', mask_size=mask_size)
    ...
    with torch.no_grad():
        for ind,batch in enumerate(dataloader):
            ...
            print('{:.2f}% done, with miou = {:.4f}, mriou = {:.4f}, mpiou = {:.4f}, m_fp = {:.4f}'\
        ...
        m_iou_score = m_iou/m_t
        m_fp_score = m_fp_ratio/m_non_t
        print('m_iou = {:.4f}, mriou = {:.4f}, mpiou = {:.4f}, mfp={:.4f}'.format(m_iou_score, mr_iou/m_t, mp_iou/m_t, m_fp_score))
